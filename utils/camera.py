...
def triangulate_points(cam1, cam2, tracking):
  ...
  # print("E1:", E1)
  # print("P1:", P1)
  # print("Trianglulate P1:", get_triangulation_params(cam=cam1, main=True))
  # print("E2:", E2)
  # print("P2:", P2)
...
def get_triangulation_params(cam, E=None, main=False):
  if main or E is None:
    E = np.hstack((np.identity(n=3, dtype=np.float32), np.zeros((3, 1), dtype=np.float32)))
  else:
    E = E[:-1, :]
...
class Camera:
    ...
    def to_opencv(self):
        ...
        projection[0, 0], projection[1, 1] = fx, fy
        projection[0, 2], projection[1, 2] = cx, cy
        projection[2, 2] = 1
        projection[3, 3] = 1
