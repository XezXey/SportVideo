...
if __name__ == '__main__':
  ...
  trajectory_3d, tracking_dict = sv.extract_3d_tracking(tracking_1, tracking_2)
  sv.visualize_calibration(trajectory_3d=trajectory_3d)
  traj_and_track = sv.split_trajectory(trajectory_3d=trajectory_3d, tracking_dict=tracking_dict)
  sv.visualize_tracking_along_3d(traj_and_track=traj_and_track)
  sv.preprocess_save_to_npy(traj_and_track=traj_and_track)
